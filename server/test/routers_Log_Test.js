...
describe("Log Router", function() {
    ...
    describe("Finding Log By Id", function() {
        ...
        it("Should find a log by id", function(done) {
            ...
            async.series({
                ...
                find: function(callback) {
                    request(app).get('/api/logs/' + logId)
                        .end(function(err, res) {
                            callback(err, res);
                        });
                }
        ...
        it("Should not find a log by id using an unknown id", function(done) {
            request(app).get('/api/logs/' + 'c85e6a70-8a38-11e4-8561-773af88e4896')
                .end(function(err, res) {
                    try {
                        should.equal(err, null);
        ...
        it("Should send error when using an invalid id", function(done) {
            request(app).get('/api/logs/' + 'abc123')
                .end(function(err, res) {
                    try {
                        should.equal(err, null);
                        res.status.should.equal(404);
        ...
        it("Should handle failure from service", function(done) {
            var stub = sinon.stub(LogModel.prototype, 'findById', function(data, callback) {
                callback(true);
            });
    ...
    describe("Updating a Log", function() {
        ...
        it("Should update a log", function(done) {
            ...
            async.series({
                ...
                update: function(callback) {
                    request(app).put('/api/logs/' + logId)
                        .send({
                            name: "Orchid"
                        })
                        .end(function(err, res) {
        ...
        it("Should fail to update an unknown log id", function(done) {
            ...
            async.series({
                ...
                update: function(callback) {
                    request(app).put('/api/logs/' + 'c85e6a70-8a38-11e4-8561-773af88e4896')
                        .send({
                            name: "Orchid"
                        })
                        .end(function(err, res) {
    ...
    describe("Deleting a Log", function() {
        ...
        it("Should delete a log", function(done) {
            ...
            async.series({
                ...
                del: function(callback) {
                    request(app).delete('/api/logs/' + logId)
                        .end(function(err, res) {
                            callback(err, res);
                        });
                }
        ...
        it("Should not delete a log with an unknown id", function(done) {
            ...
            async.series({
                ...
                del: function(callback) {
                    request(app).delete('/api/logs/' + 'c85e6a70-8a38-11e4-8561-773af88e4896')
                        .end(function(err, res) {
                            callback(err, res);
                        });
                }
        ...
        it("Should not delete a log with an invalid id", function(done) {
            ...
            async.series({
                ...
                del: function(callback) {
                    request(app).delete('/api/logs/' + 'badId')
                        .end(function(err, res) {
                            callback(err, res);
                        });
                }
